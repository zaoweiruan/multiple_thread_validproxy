...
| 日期 | 类型 | 文档路径 | 说明 |
|------|------|----------|------|
| 2026-09-14 | plan | `docs/plans/2026-09-14-Plan-PoolMemberHealthProbeWorkers-v1.0.md` | 代理池成员健康探针 worker 实施计划 — Task 1-4 已实施（ConfigReader `evaluate.probeWorkers` 字段 + ProxyProbePool 常驻探针池 + ProxyHealthEvaluator 接线 + StandaloneProxyPool 生命周期接线，commit 4ea257a/f4c8e84/e622739/1eec320）；Task 5 文档修订（Note/Spec/tracker/INDEX 登记） | ⏳ in-progress |
