...
| 日期 | 类型 | 文档路径 | 说明 |
|------|------|----------|------|
| 2026-09-15 | spec+plan | docs/specs/2026-09-15-Spec-AddPoolMemberDialog-Enhance-v1.0.md + docs/plans/2026-09-15-Plan-AddPoolMemberDialog-Enhance-v1.0.md | 代理池添加代理弹窗增强 — 有效过滤（delay>0）+ 8 列（时延/Region/健康度/Message/协议名）+ 单击列头排序 + Shift+单击多选；Task 1-6 实施中 | ⏳ in-progress |
