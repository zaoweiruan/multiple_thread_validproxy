...
| 日期 | 类型 | 文档路径 | 说明 |
|------|------|----------|------|
| 2026-09-15 | spec+plan | docs/specs/2026-09-15-Spec-PoolInjectDuplicateGuard-v1.0.md + docs/plans/2026-09-15-Plan-PoolInjectDuplicateGuard-v1.0.md | 代理池重复注入防护 — injectMember 显式检查 members_，重复 indexId 返回 false + WARN 日志（"already in pool"），不调用 addOutboundDirect；Task 1-3 实施中 | ⏳ in-progress |
